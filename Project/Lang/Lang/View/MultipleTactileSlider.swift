...
@IBDesignable class MultipleTactileSlider: UIControl {
    ...
    @IBInspectable open var trackBackground: UIColor = UIColor(red: 215/255.0, green: 215/255.0, blue: 215/255.0, alpha: 1) {
        didSet {
    ...
    @IBInspectable open var thumbTint: UIColor = UIColor(red: 36/255.0, green: 116/255.0, blue: 130/255.0, alpha: 1) {
        didSet {
    ...
    private let renderer = MultipleTactileSliderLayerRenderer()
