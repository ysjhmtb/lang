//
//  MultipleTactileSliderLayerRenderer.swift
//  Lang
//
...
class MultipleTactileSliderLayerRenderer {
    weak var tactileSlider: MultipleTactileSlider?
        ...
        var thumbTint: UIColor = UIColor(red: 36/255.0, green: 116/255.0, blue: 130/255.0, alpha: 1) {
            didSet {
    ...
    //        print("TactileSliderLayerRenderer init")
            trackLayer.backgroundColor = trackBackground.cgColor
            thumbLayer.fillColor = thumbTint.cgColor
            maskLayer.fillColor = UIColor(red: 36/255.0, green: 116/255.0, blue: 130/255.0, alpha: 1).cgColor
