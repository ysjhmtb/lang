...
@IBDesignable class VolumeTactileSlider: UIControl {
        ...
        @IBInspectable open var thumbTint: UIColor = UIColor(red: 70/255.0, green: 101/255.0, blue: 147/255.0, alpha: 1) {
            didSet {
        ...
        private let renderer = VolumeTactileSliderLayerRenderer()
